...
def sanitized_telegram_report(report):
    return {
        ...
        "messages_processed": report.get("messages_processed", 0),
        "start_cursor": report.get("start_cursor"),
        "end_cursor": report.get("end_cursor"),
        "batch_size": report.get("batch_size", 0),
        "batch_limit_reached": report.get("batch_limit_reached", False),
        "backlog_may_remain": report.get("backlog_may_remain", False),
